...
local _W = xWidth  --These were changed so that fading between scenes doens't mess up on any devices!
local _H = yHeight
...
protection.x = _W*0.5; protection.y = _H*0.5
...
local function changeScene( params,
	...
	elseif effect == "fade" then
		...
		nextView.x = _W+_W*0.5
		nextView.y = 0
		--
		local fade = display.newRect( -_W, -_H, _W * 3, _H * 3 )
		fade.x = _W*0.5; fade.y = _H*0.5
		fade.alpha = 0
