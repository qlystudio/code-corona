...
local church
                        ...
                        if ( playerMeme.nextIndice < playerMeme.touchIndice ) then
                                ...
                                if ( playerMeme.nextIndice < playerMeme.touchIndice - 1) then
                                        if (playerMeme.x < playerMeme.touchPointsX[playerMeme.nextIndice + 1]) then
                                                changePlayerImage("level1/astronaut_without_gun_right.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        else
                                                changePlayerImage("level1/astronaut_without_gun_left.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        end
                                end
        ...
        function createLaserEnemyMeme(imageFile, x, y)
                ...
                Runtime:addEventListener("tap",enemyMeme)
                ...
                function enemyMeme:tap( event )
                        ...
                        enemyMeme.alpha=0.0
                        createExplosion(enemyMeme.x,enemyMeme.y)
        ...
        local playerMeme1 = createPlayerMeme("level1/astronaut_without_gun_right.png", 50, display.contentHeight*0.5, 1)
        ...
        function endBeforeTheEnd()
                ...
                local sheet1 = sprite.newSpriteSheet( "level1/level_end_dialog_licinio_sprite.png", 882, 177 )
        ...
        function resetField(help_img)
                transition.to(help_img,{alpha=0.0})
