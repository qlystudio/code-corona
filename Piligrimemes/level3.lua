...
local church
        ...
        local drawBackground = function()
                ...
                ambientSound = audio.loadSound("level1/nyan_cat_spanish.mp3")
                        ...
                        if ( playerMeme.nextIndice < playerMeme.touchIndice ) then
                                ...
                                if ( playerMeme.nextIndice < playerMeme.touchIndice - 1) then
                                        if (playerMeme.x < playerMeme.touchPointsX[playerMeme.nextIndice + 1]) then
                                                changePlayerImage("level1/astronaut_with_flower_right.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        else
                                                changePlayerImage("level1/astronaut_with_flower_left.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        end
                                end
                ...
                --print(angleBetween)
                        ...
                        if ( nyanCat.nextIndice < nyanCat.touchIndice) then
                                ...
                                if(nyanCat.trailcounter>=8) then
                                        ...
                                        --trail2:setFillColor(100,100,100,0)
                                        backgroundGroup:insert(trail2)
                                        transition.to(trail2, {alpha=0.0,time=1000, onComplete=display.remove})
                                        ...
                                        backgroundGroup:insert(trail3)
                                        transition.to(trail3, {alpha=0.0,time=1000, onComplete=display.remove}) 
                                        ...
                                        backgroundGroup:insert(trail1)
                                        transition.to(trail1, {alpha=0.0,time=1000, onComplete=display.remove})
                                        nyanCat.trailcounter=0
                                end
                        else
                        --chegou ao fim do caminho.
        ...
        function createExplosion(howmany,x,y)
                ...
                particles.howmany=math.ceil(howmany/2)
                particles.frames = 0
        ...
        function updateParticle(particle)
                ...
                transition.to(tmpCircle,{alpha=0.0,time=300, onComplete=display.remove})
        ...
        local playerMeme1 = createPlayerMeme("level1/astronaut_with_flower_right.png", 50, display.contentHeight*0.5, 1)
        ...
        function createFirstSceneCats()
              ...
              --  print ("SIZE BEFORE",# enemyMemeTable)
                local nyanCat1 = createNyanCat("level1/nyan_cat_spain_right.png",1.5,color1,color2,color3,startx_one,-100,endx_one,display.contentHeight+100)
        ...
        function createSecondSceneCats()
                ...
                local nyanCat2 = createNyanCat("level1/nyan_cat_spain_right_left.png",1.5,color1,color2,color3,startx_two,display.contentHeight+100,endx_two,-100)
        ...
        function endBeforeTheEnd()
                ...
                local sheet1 = sprite.newSpriteSheet( "level1/level_end_dialog_rui_sprite.png", 882, 177 )
                ...
                timer.performWithDelay(6000, myclosure )
                print("AFTER THE END")
        end
        ...
        function bigShip(c)
                ...
                c.alpha=0.0
            --    print("HEEEERE")
                bigShipDisplay=display.newImageRect("level1/spaceship_front_rui.png",1920,1200)
