...
local church
        ...
        local drawBackground = function()
                ...
                ambientSound = audio.loadSound("level1/nyan_cat_portuguese.mp3")
                        ...
                        if ( playerMeme.nextIndice < playerMeme.touchIndice ) then
                                ...
                                if ( playerMeme.nextIndice < playerMeme.touchIndice - 1) then
                                        if (playerMeme.x < playerMeme.touchPointsX[playerMeme.nextIndice + 1]) then
                                                changePlayerImage("level1/astronaut_with_wig_right.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        else
                                                changePlayerImage("level1/astronaut_with_wig_left.png", playerMeme)
                                                playerMeme.image:addEventListener( "touch", touchListener )
                                        end
                                end
               ...
               --enemyMemeTable[# enemyMemeTable + 1] = nyanCat
                ...
                --print(angleBetween)
                        ...
                        if ( nyanCat.nextIndice < nyanCat.touchIndice) then
                                ...
                                if(nyanCat.trailcounter>=4) then
        ...
        function updateParticle(particle)
                ...
                transition.to(tmpCircle,{alpha=0.0,time=200, onComplete=display.remove})
        ...
        local playerMeme1 = createPlayerMeme("level1/astronaut_with_wig_right.png", 50, display.contentHeight*0.5, 1)
        ...
        function createFirstSceneCats()
              ...
              --  print ("SIZE BEFORE",# enemyMemeTable)
                local nyanCat1 = createNyanCat("level1/nyan_cat_pt_right.png",2,color1,color2,color3,startx_one,-100,endx_one,display.contentHeight+100)
        ...
        function createSecondSceneCats()
                ...
                local nyanCat2 = createNyanCat("level1/nyan_cat_pt_right.png",2,color1,color2,color3,startx_two,display.contentHeight+100,endx_two,-100)
        ...
        function bigShip(c)
                ...
                c.alpha=0.0
            --    print("HEEEERE")
                bigShipDisplay=display.newImageRect("level1/spaceship_front_jesus.png",1920,1200)
        ...
        function changeScene(bs)
            --    print("GOING OUT!")
                director:changeScene("final", "moveFromRight")
        end
