...
local score = 0
gamestate.data.selectedScore = 0
------------------
-- Groups
------------------
...
local church
        ...
        local drawBackground = function()
                ...
                ambientSound = audio.loadSound("level1/challenge.mp3")
        ...
        function createPlayerMeme(imageFile, x, y, speed)
               ...
               -- playerMeme.image:addEventListener( "touch", touchListener )
                ...
                playerMeme.x, playerMeme.y = display.contentWidth/2, display.contentHeight/2
                playerMeme.image.x,playerMeme.image.y=display.contentWidth/2, display.contentHeight/2
        ...
        function playerMemeTable:enterFrame ( event )
            ...
            return
                ...
                if(randomEnemy >= timing) then
                        generateGhost(playerMemeTable[1])
                        randomEnemy=0
                        timing = math.max(timing*0.96,18)
                        print(timing)
        ...
        function bigShip(c)
                ...
                c.alpha=0.0
            --    print("HEEEERE")
                bigShipDisplay=display.newImageRect("level1/spaceship_front_licinio_small.png",1920,1200)
