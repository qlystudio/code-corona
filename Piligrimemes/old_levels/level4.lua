...
church.yScale=1.7
       ...
       -- table.insert(playerMemeTable, playerMeme2)
        ...
        local friendlyMeme1 = createFriendlyMeme("old_levels/cry.png")
        
        table.insert(friendlyMemeTable, friendlyMeme1)

        
        local enemyMeme1 = createLaserEnemyMeme("old_levels/falone.png", display.contentWidth*0.7, display.contentHeight*0.5)
