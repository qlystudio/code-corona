...
local function createPlayScreen()
	local background = display.newImage("newBackground.jpg")
	background.y = 130
	background.alpha = 0
	
	planet = display.newImage("cake.jpg")
	planet.x = centerX
	...
	local function showTitle()
		gameTitle = display.newImage("title.jpg")
		gameTitle.alpha = 0
		gameTitle:scale(4, 4)
	...
	scoreTxt.y = 10
	scoreTxt.alpha = 0
	scoreTxt:setTextColor(14, 14, 14)
end	

-- game functions

function spawnEnemy()
	local enemypics = {"lady_running.jpg","fat_guy.jpg", "baby_running.jpg"}
